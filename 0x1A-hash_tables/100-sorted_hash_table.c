...
/**
 * shash_sorted_list_update - ata hii unadai?
 * @ht: hash table
 * @new_node: nodes
 * @key: keys
 * @value: values
...
/**
 * shash_sorted_list_insert - soma func
 * @ht: hash table
 * @new_node: nodes
 * @key: keys
 * Return: 1 else 0
...
/**
 * shash_insert_into_sorted_list - concatination happening
 * @ht: hash table
 * @key: keys.
 * @value: values.
 * Return: 1 else 0
...
/**
 * shash_insert_into_array - concatenates array
 * @ht: hash table
 * @key: keys.
 * @value: values.
 * Return: 1 else 0
...
/**
 * shash_table_set - sets it up
 * @ht: hash table.
 * @key: key.
 * @value: value.
 * Return: ht, key and value or NULL
 */
...
/**
 * shash_table_print - prints head first
 * @ht: hash table
 * Return: void
 */
...
/**
 * shash_table_print_rev - prints the stail first
 * @ht: hash table
 * Return: void
 */
...
/**
 * shash_table_delete_arr - deletes the array
 * @ht: hash table
 * Return: void
 */
...
/**
 * shash_table_delete_slist - frees sorted list
 * @ht: hash table
 * Return: void
 */
...
/**
 * shash_table_delete - frees array and list
 * @ht: hash table
 * Return: void
 */
